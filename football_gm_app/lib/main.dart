...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Configure ApiService baseUrl here. For Android emulator, use 10.0.2.2
...
class TeamsProvider extends ChangeNotifier {
  ...
  Future<void> sync() async {
    ...
    try {
      ...
      // ignore for now; consider exposing an error state
    }
    loading = false;
    notifyListeners();
  }
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  icon: provider.loading ? const SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2)) : const Icon(Icons.sync),
